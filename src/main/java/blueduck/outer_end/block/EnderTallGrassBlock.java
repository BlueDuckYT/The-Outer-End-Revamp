...
public class EnderTallGrassBlock  extends Block implements net.minecraftforge.common.IPlantable{
    public EnderTallGrassBlock(BlockBehaviour.Properties p_51021_) {
        super(p_51021_);
    }
