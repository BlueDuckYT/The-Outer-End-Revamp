...
import blueduck.outer_end.entity.SinkerLaser;
...
@OnlyIn(Dist.CLIENT)
public class SinkerLaserRenderer<T extends SinkerLaser> extends EntityRenderer<T> {
    public static final ResourceLocation SPECTRAL_ARROW_LOCATION = new ResourceLocation(TheOuterEnd.MODID, "textures/entity/sinker_laser.png");

    public SinkerLaserRenderer(EntityRendererProvider.Context p_174399_) {
        super(p_174399_);
    }

    public ResourceLocation getTextureLocation(T p_116001_) {
